 ...
 */
function theme_imtpn_telecom_paris_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @param $page
 */
function theme_imtpn_telecom_paris_page_init($page) {
